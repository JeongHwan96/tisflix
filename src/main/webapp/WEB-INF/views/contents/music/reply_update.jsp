...
<body>
	...
	<div class="formBox">
	<h2>REPLY UPDATE</h2>
	<form method="POST" action="MusicReplyUpdate.do" id="joinForm" >
		...
		<div class="btns col text-right" var="musicReplyBean" items="${musicReplyBean}">
			<input type="hidden" name="rno" id="rno" value="${musicReplyBean.rno}">	
