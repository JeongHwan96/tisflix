...
<body>
	...
	<div class="formBox">
	<h2>REPLY UPDATE</h2>
	<form method="POST" action="MovieReplyUpdate.do" id="joinForm" >
		...
		<div class="btns col text-right" var="movieReplyBean" items="${movieReplyBean}">
			<input type="hidden" name="rno" id="rno" value="${movieReplyBean.rno}">	
